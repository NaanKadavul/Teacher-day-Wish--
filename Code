...
<head>
  ...
  <title>🌸 Happy Teacher's Day — Personalised Wish</title>

  <!-- Tamil font + Poppins for English UI -->
  ...
  <style>
    ...
    *{box-sizing:border-box}
    html,body{height:100%;margin:0;font-family:'Poppins', 'Noto Sans Tamil', sans-serif;background:linear-gradient(120deg,#0f172a 0%, #4c1d95 40%, #7c3aed 100%);color:#fff}
    ...
    .stage{
      width:100%;max-width:980px;background:linear-gradient(180deg, rgba(255,255,255,0.03), rgba(255,255,255,0.01));border-radius:20px;padding:28px;box-shadow:0 20px 60px rgba(2,6,23,0.6);position:relative;overflow:hidden;border:1px solid rgba(255,255,255,0.06)
    }

    /* top decorative rings */
    .stage::before, .stage::after{
      content:'';position:absolute;border-radius:999px;filter:blur(40px);opacity:0.15
    }
    .stage::before{width:360px;height:360px;background:linear-gradient(135deg,#ff7ab6,#ffcf6c);right:-120px;top:-150px}
    .stage::after{width:500px;height:500px;background:linear-gradient(135deg,#6ee7b7,#60a5fa);left:-220px;bottom:-160px}
    ...
    /* left - input card */
    .input-card{background:linear-gradient(180deg, rgba(255,255,255,0.02), rgba(255,255,255,0.01));padding:28px;border-radius:14px;border:1px solid rgba(255,255,255,0.04)}
    .input-card h2{font-size:26px;margin:0 0 8px;color:var(--accent);text-shadow:0 6px 18px rgba(245,158,11,0.08)}
    .input-card p{margin:0 0 16px;color:rgba(255,255,255,0.85)}
    .field{display:flex;gap:8px}
    input[type=text]{flex:1;padding:14px 16px;border-radius:10px;border:1px solid rgba(255,255,255,0.06);background:transparent;color:#fff;font-size:16px;outline:none}
    button.primary{background:linear-gradient(90deg,#f59e0b,#f97316);border:none;padding:12px 18px;border-radius:10px;font-weight:700;color:#081127;cursor:pointer;box-shadow:0 8px 28px rgba(245,158,11,0.12)}
    button.secondary{background:transparent;border:1px solid rgba(255,255,255,0.08);padding:10px 14px;border-radius:10px;color:#fff;cursor:pointer}

    .preview{display:flex;flex-direction:column;align-items:center;justify-content:center;padding:18px;border-radius:12px;background:linear-gradient(180deg, rgba(255,255,255,0.02), rgba(255,255,255,0.01));border:1px solid rgba(255,255,255,0.03)}
